...
export const addToReadingListUndoClicked = createAction(
  '[Books Search Results] Add to list undo button clicked',
  props<{ book: Book }>()
);
...
export const removeFromReadingListUndoClicked = createAction(
  '[Books Search Results] Remove from list undo button clicked',
  props<{ item: ReadingListItem }>()
);
